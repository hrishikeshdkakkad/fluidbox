...
2026-07-10 (pushed; code frozen at 95177e5, followed by docs-only commits).
...
- Check `git status` FIRST — the tree should be CLEAN and in sync with origin/main, with no code commits after 95177e5 (docs-only commits follow it); if it isn't, ask me before starting. ultrathink
