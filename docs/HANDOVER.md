...
- **Phase 3 (scheduled borrowing: scheduler worker, cron/timezone, missed-run + concurrency policies, retryable delivery)** — ⏭ **next**. §17 decision to settle at that boundary: #5 (schedule missed-run and overlap defaults).
