...
## [0.9.0](https://github.com/hrishikeshdkakkad/fluidbox/compare/v0.8.0...v0.9.0) (2026-08-26)


### Added

* **core:** add queued session status with capacity-park edges ([a2fafec](https://github.com/hrishikeshdkakkad/fluidbox/commit/a2fafec1a140ffd248b0ad2f6bc0f054c28ace16)), closes [#152](https://github.com/hrishikeshdkakkad/fluidbox/issues/152)
* **db:** run-queue columns (0034), transition stamps, launch-anchored stale sweep ([1371ca2](https://github.com/hrishikeshdkakkad/fluidbox/commit/1371ca246669c401f804085faa72615cd696397d)), closes [#153](https://github.com/hrishikeshdkakkad/fluidbox/issues/153)
* **db:** serialized dispatch claim + capacity occupancy loaders ([57443fe](https://github.com/hrishikeshdkakkad/fluidbox/commit/57443fe27f11c80975a5fed5f8e980e47251c452)), closes [#154](https://github.com/hrishikeshdkakkad/fluidbox/issues/154)
* **gcp:** an optional OpenAI key for the gateway, declared but not yet provisioned ([1636227](https://github.com/hrishikeshdkakkad/fluidbox/commit/1636227a937e5b5d2a3de437fa1b0dcdb6360ba6))
* **gcp:** Auth0 hardening + live isolation/egress evidence ([69b00df](https://github.com/hrishikeshdkakkad/fluidbox/commit/69b00df8bb1c232a7f10678cfae34589127500f7))
* **gcp:** cilium_mode — self-managed upstream Cilium for governed egress ([2112bf8](https://github.com/hrishikeshdkakkad/fluidbox/commit/2112bf860a16c4df68f14d3c79031488048c256a))
* **gcp:** GKE production deployment — Terraform, chart hardening, commit-to-prod pipeline ([eb4f9ad](https://github.com/hrishikeshdkakkad/fluidbox/commit/eb4f9add60ebdbc5baef12d123acee6a16e35096))
* **gcp:** production deployment on GKE — Terraform, chart hardening, commit-to-prod pipeline ([d753141](https://github.com/hrishikeshdkakkad/fluidbox/commit/d7531413f35ff187e03ca3215fccea8703a0467e))
* **gcp:** production opts into OpenAI through the optional secret ([313dac1](https://github.com/hrishikeshdkakkad/fluidbox/commit/313dac1e359a56e8046e341ca00f3eecd77adc0e))
* **gcp:** the sandbox pool is on-demand with one node always present ([8afe0c0](https://github.com/hrishikeshdkakkad/fluidbox/commit/8afe0c08e4fdf950a7d280bfde633048a65d89a5))
* **gcp:** upstream Cilium for governed sandbox egress ([feaa5dc](https://github.com/hrishikeshdkakkad/fluidbox/commit/feaa5dca9cf4f0a303aea27b5af8f1295f6c9f02))
* **helm:** optional provider secrets in their own ExternalSecret ([314b884](https://github.com/hrishikeshdkakkad/fluidbox/commit/314b8842f1e13f2445b158dfccd3d47c703b81f1))
* instrument the db, provider and workspace crates ([9beb85e](https://github.com/hrishikeshdkakkad/fluidbox/commit/9beb85e2dab7d6b3136e7accb2cc1797ef95f571))
* **obs:** fluidbox-obs — structured, redacted, correlated logging ([67e6d52](https://github.com/hrishikeshdkakkad/fluidbox/commit/67e6d52ec61549a8bee72b7490b5372f73dbf248))
* **provider:** typed CapacityDenied classification for quota and throttle rejections ([08819c4](https://github.com/hrishikeshdkakkad/fluidbox/commit/08819c49e32b2598649d2841994011b3ff247a9a)), closes [#155](https://github.com/hrishikeshdkakkad/fluidbox/issues/155)
* **runner:** structured, redacted logging inside the sandbox ([ca9c897](https://github.com/hrishikeshdkakkad/fluidbox/commit/ca9c8973fc5890b4e651333b138c09c8a193630c))
* **scripts:** gcp-reauth.sh - restore local gcloud credentials ([9f3edef](https://github.com/hrishikeshdkakkad/fluidbox/commit/9f3edef99da4682928e6669c5b2bfe9817171c1a))
* **scripts:** gcp-secrets.sh - the out-of-band secrets in one command ([ef92da2](https://github.com/hrishikeshdkakkad/fluidbox/commit/ef92da248be8e04c8b910770662ae736c1b4e03f))
* **server:** boot on fluidbox-obs, and one canonical record per request ([0631dd5](https://github.com/hrishikeshdkakkad/fluidbox/commit/0631dd538c6c9ac8af3ad298c57fc5498cc8fd05))
* **server:** bounded queue depth with per-entry-point shed semantics ([c3e3c06](https://github.com/hrishikeshdkakkad/fluidbox/commit/c3e3c068f251d2d02542dec9a5368313e01106a7)), closes [#159](https://github.com/hrishikeshdkakkad/fluidbox/issues/159)
* **server:** capacity dispatcher + park-at-admission (inert unless configured) ([7b336ae](https://github.com/hrishikeshdkakkad/fluidbox/commit/7b336ae8a0114bbc91e167175ff08ceba96ba669)), closes [#157](https://github.com/hrishikeshdkakkad/fluidbox/issues/157)
* **server:** instrument the credential and egress plane, and the boot banner ([663c031](https://github.com/hrishikeshdkakkad/fluidbox/commit/663c03192e01d8c9f4b34d637217acd64329a786))
* **server:** instrument the governance plane ([efa924a](https://github.com/hrishikeshdkakkad/fluidbox/commit/efa924ae65b8804ce66fe1d6b92b378fe7c43d3e))
* **server:** instrument the run lifecycle plane ([6cbc0d0](https://github.com/hrishikeshdkakkad/fluidbox/commit/6cbc0d080db7f3b1e8462eab17e57a421354c47a))
* **server:** queue observability — live gauges, requeue counter, queued position in the session API ([3d1d956](https://github.com/hrishikeshdkakkad/fluidbox/commit/3d1d956188eb81e451eef10f1635b3219057eb88)), closes [#161](https://github.com/hrishikeshdkakkad/fluidbox/issues/161)
* **server:** reconcile every tenant's LiteLLM key against the configured allowlist ([11b2b5f](https://github.com/hrishikeshdkakkad/fluidbox/commit/11b2b5f8e0649a7bf2b4b9397ec57e3bc8dbf614))
* **server:** requeue runs on provider capacity denial with bounded backoff ([053a242](https://github.com/hrishikeshdkakkad/fluidbox/commit/053a242dfe7d3663fe5927de3e33a3ac4342fc30)), closes [#158](https://github.com/hrishikeshdkakkad/fluidbox/issues/158)
* **server:** run-queue configuration knobs (inert unless cap set) ([30985f9](https://github.com/hrishikeshdkakkad/fluidbox/commit/30985f9d4f4f8b640802bc37938173b22613a4de)), closes [#156](https://github.com/hrishikeshdkakkad/fluidbox/issues/156)
* **test:** feature-gated NullProvider + hermetic queue-admission e2e ([5f4517a](https://github.com/hrishikeshdkakkad/fluidbox/commit/5f4517ade1f7654a82165723f6b64122e28f3bf8)), closes [#160](https://github.com/hrishikeshdkakkad/fluidbox/issues/160)


### Fixed

* **chart:** migrate-job identity, LiteLLM PSA baseline, ESO api version ([fcb9901](https://github.com/hrishikeshdkakkad/fluidbox/commit/fcb9901658efcc00686ed3d56449279aac430c1b))
* **chart:** three networkGrants defects, and the precise GKE blocker ([4c812e4](https://github.com/hrishikeshdkakkad/fluidbox/commit/4c812e464666e20e71799a350b845dbb7cc5d078))
* **chart:** three real defects in the networkGrants path, and the precise reason it cannot work on GKE ([e2f2e30](https://github.com/hrishikeshdkakkad/fluidbox/commit/e2f2e30ddf01c30475c43b53f5c03556e6994210))
* **ci:** always deploy a digest built from the commit ([ead7ba7](https://github.com/hrishikeshdkakkad/fluidbox/commit/ead7ba7ddb34179351ee3329007e44d3b37efeed))
* **ci:** build images IF ABSENT for the commit, never fall back to a live tag ([99b1a45](https://github.com/hrishikeshdkakkad/fluidbox/commit/99b1a459a21b5407131b71ff39b6d832947ff05d))
* **ci:** gate apply on the plan JSON's change count, not on a captured exit code ([1ad015c](https://github.com/hrishikeshdkakkad/fluidbox/commit/1ad015cf016286a0d3b2c828be0facfb905ab54f))
* **ci:** helm waits for workloads and jobs, not for every custom resource ([65c2e44](https://github.com/hrishikeshdkakkad/fluidbox/commit/65c2e442225674f7e017ac993fb9a1a5a88570b1))
* **ci:** pin helm, drop deprecated --atomic, add handoff doc ([3c73df4](https://github.com/hrishikeshdkakkad/fluidbox/commit/3c73df47cc660374c9075da7efc56c33f36c921e))
* **ci:** pin helm, drop the deprecated --atomic, and add the handoff doc ([ef908ac](https://github.com/hrishikeshdkakkad/fluidbox/commit/ef908acd5cf0dce72c56ae145b075d599437519a))
* **ci:** plan on every push to main; apply when the plan has changes ([4429016](https://github.com/hrishikeshdkakkad/fluidbox/commit/4429016b72c19b0539f332a8cc15ac2037c3c39c))
* **ci:** pull-request plans must not share the production deploy's concurrency group ([2b7873e](https://github.com/hrishikeshdkakkad/fluidbox/commit/2b7873e27bfc3c2d5b9fa8a513715eb804c0e75d))
* **ci:** smoke needs always() — a green pipeline was verifying nothing ([e568cb0](https://github.com/hrishikeshdkakkad/fluidbox/commit/e568cb0731a64e648205c8c3d943730fbac24d2e))
* **ci:** smoke needs always() — skips propagate transitively through needs ([047c82c](https://github.com/hrishikeshdkakkad/fluidbox/commit/047c82c47eff36bd292e7737d7f4b3cd88617c16))
* **ci:** the deploy pipeline never tested its own gates ([fcbd627](https://github.com/hrishikeshdkakkad/fluidbox/commit/fcbd6277c80d2e33adf539d5619ead470f13055d))
* **ci:** the deploy pipeline never tested its own gates ([dc365de](https://github.com/hrishikeshdkakkad/fluidbox/commit/dc365deb46cd206b0da32eeef9255021088f9f24))
* **ci:** WIF audience + pnpm — unblock the deploy pipeline ([7ad1eeb](https://github.com/hrishikeshdkakkad/fluidbox/commit/7ad1eebafeab0e900b09871bb1a623e922ae03ab))
* **ci:** WIF audience mismatch and a missing pnpm broke the first deploy run ([f9e0b97](https://github.com/hrishikeshdkakkad/fluidbox/commit/f9e0b97f7680ca166b3ee59d340ec960e3ef84c1))
* **evidence:** the verification suites were quietly verifying less than they claimed ([19ada89](https://github.com/hrishikeshdkakkad/fluidbox/commit/19ada893f4326baf2b89f2a9a7a634b1c92d4f75))
* **evidence:** three ways these suites were quietly verifying less than they said ([803070c](https://github.com/hrishikeshdkakkad/fluidbox/commit/803070cf882308fe3b564a322327e890234848d4))
* **gcp:** apply-time corrections + browser journeys, isolation checks, docs ([744a029](https://github.com/hrishikeshdkakkad/fluidbox/commit/744a0296016a48c5f4a95ac21b818c0f4fed6e4a))
* **gcp:** cilium_mode must default to the mode actually deployed ([75b0a72](https://github.com/hrishikeshdkakkad/fluidbox/commit/75b0a72fb5d2c6273a4ea1381dbf5d0814d6d4ab))
* **gcp:** declare the release-namespace label Helm owns ([3efccf4](https://github.com/hrishikeshdkakkad/fluidbox/commit/3efccf4d4a869a6b62f7eff3141bcc7309903db8))
* **gcp:** ingress must use the legacy class ANNOTATION, not ingressClassName ([a2352c5](https://github.com/hrishikeshdkakkad/fluidbox/commit/a2352c53f767a1da88e2ccfa7c978b922bfef408))
* **gcp:** node pools were created EMPTY — initial_node_count, not node_count ([e0bd392](https://github.com/hrishikeshdkakkad/fluidbox/commit/e0bd392b2f533de36cf9d4660de6ef169575a9d2))
* **gcp:** the Cilium startup taint deadlocked every scale-from-zero ([961a384](https://github.com/hrishikeshdkakkad/fluidbox/commit/961a38461f133b85d4ce319abefabdcfe6963918))
* **obs:** close logging review gaps ([a7c6eb1](https://github.com/hrishikeshdkakkad/fluidbox/commit/a7c6eb1620e8db2e5b542dfd6e65dc65ed8641a6))
* **obs:** close the last unredacted path, and make a boot failure a record ([82c7235](https://github.com/hrishikeshdkakkad/fluidbox/commit/82c72350b95e12d3c66683da7460f69bc4b412f8))
* **provider-k8s:** the network verifier must wait for a node before it starts its clock ([80467f1](https://github.com/hrishikeshdkakkad/fluidbox/commit/80467f1fb3791664ab00e1223abf1430b69b9b52))
* **provider-k8s:** the verifier's timeout states are per poll, not carried ([45efc5a](https://github.com/hrishikeshdkakkad/fluidbox/commit/45efc5aaa6bbcd89e16eb659f2d38711c05af96a))
* **scripts:** gcp-secrets.sh refuses to rotate a key it was not told to rotate ([26df213](https://github.com/hrishikeshdkakkad/fluidbox/commit/26df213dc167bf592a86ceea3f21c1d218b337a5))
* **server:** a run that fails at provisioning finalizes at once, not after a settle window ([53bef4f](https://github.com/hrishikeshdkakkad/fluidbox/commit/53bef4fa3569f9745ddb23f714e1bca2e2410602))
* **server:** the catalog and agent writes must respect the tenant model allowlist ([dc6a43d](https://github.com/hrishikeshdkakkad/fluidbox/commit/dc6a43d07f3d515a3227b562805fbba8ba1fbee8))
* **server:** the reconciler adopted sandboxes a live driver was still provisioning ([c80f32f](https://github.com/hrishikeshdkakkad/fluidbox/commit/c80f32fdf393259fcb183773dd80bf4c65f1eb51))
* **web:** logout returned 500 - the proxy put a body on a 204 ([1a54c46](https://github.com/hrishikeshdkakkad/fluidbox/commit/1a54c46457569839dce248631c6c36b1847f5520))
* **web:** unblock the Vercel build, and correct the vercel job's working dir ([0600471](https://github.com/hrishikeshdkakkad/fluidbox/commit/0600471d2ecf95103c8f882d282628e346c695df))


### Documentation

* **gcp:** a cancelled push run with no failed job is the concurrency race ([a4a0eb3](https://github.com/hrishikeshdkakkad/fluidbox/commit/a4a0eb317f8408c85c6f3a1303586777987d38e2))
* **gcp:** correct — governed network grants are NOT possible on GKE Dataplane V2 ([0270401](https://github.com/hrishikeshdkakkad/fluidbox/commit/02704014c2674ac10539513312731a98621578f0))
* **gcp:** correct a wrong claim — governed network grants are NOT possible on GKE DPv2 ([3535d97](https://github.com/hrishikeshdkakkad/fluidbox/commit/3535d9722389168ae7a9ff07f54b87cf6b65a61b))
* **gcp:** governed sandbox egress is ENABLED, not impossible ([f5f145d](https://github.com/hrishikeshdkakkad/fluidbox/commit/f5f145d186a04f1021d9143c2d615401a2bfefa4))
* **gcp:** one-command secrets, automatic key rotation, the two-phase verifier ([77e7fea](https://github.com/hrishikeshdkakkad/fluidbox/commit/77e7fea806d67332d411bc11f8148e4fc5741db2))
* **gcp:** record the rollback actually exercised against production ([ec8faa4](https://github.com/hrishikeshdkakkad/fluidbox/commit/ec8faa4e7914bf442fa77eeea5d44153b192187d))
* **gcp:** record the verification evidence; run vercel on manual dispatch too ([2f631a4](https://github.com/hrishikeshdkakkad/fluidbox/commit/2f631a4291ec5e186827866ee5659adddc272fac))
* **gcp:** the Cilium clusterwide flag is necessary but NOT sufficient ([f48b012](https://github.com/hrishikeshdkakkad/fluidbox/commit/f48b012b502383e564cd9478039e160fd6028232))
* **gcp:** the cordon race behind "node(s) were unschedulable", and the settle window ([3643c82](https://github.com/hrishikeshdkakkad/fluidbox/commit/3643c824fef779a989df2fb9ac3c511c38b4ec61))
* **gcp:** the DPv2MigrationUnsupportedCNIDetected node condition is expected ([61838d8](https://github.com/hrishikeshdkakkad/fluidbox/commit/61838d8a305f5ae6570e7048e114572db2b3e942))
* **gcp:** the Secrets runbook points at gcp-secrets.sh and its --rotate guard ([895eef0](https://github.com/hrishikeshdkakkad/fluidbox/commit/895eef05f0576e785b89859e3fd7642c7ed2b0b6))
* **gcp:** the startup taint, the autoscaler, and the order that matters ([593f7ae](https://github.com/hrishikeshdkakkad/fluidbox/commit/593f7ae0ee64a16554a6f46a1c8dafa839e26212))
* **gcp:** the tenant allowlist is the catalog; OpenAI is optional and absent ([53a2372](https://github.com/hrishikeshdkakkad/fluidbox/commit/53a2372f3f801f900e2f865492d89e83cd36fdad))
* **gcp:** verification record + vercel on manual dispatch ([a14d3c4](https://github.com/hrishikeshdkakkad/fluidbox/commit/a14d3c4dabc7aa3233bdd2d64788416c56afc860))
* **plans:** run admission & queueing — design + implementation plan ([54f72d6](https://github.com/hrishikeshdkakkad/fluidbox/commit/54f72d60b82f9073fd5752df84f34d3769cb92d5))
* **web:** commit .env.example — it had never been tracked ([0c2af89](https://github.com/hrishikeshdkakkad/fluidbox/commit/0c2af89e6467fb4f9dfdc1363eb4b167d587c417))
* **web:** commit .env.example — it had never been tracked ([de07764](https://github.com/hrishikeshdkakkad/fluidbox/commit/de077648eb3d49fbd52283b6ea8189abdf5d7eb0))
