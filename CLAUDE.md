...
just e2e            # full acceptance: live demo A + governance + git workspaces + api triggers + schedules + github fan-out + capability catalog + failure paths (owns the stack; stop `just dev` first)
