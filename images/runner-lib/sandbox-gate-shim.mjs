...
const child = new Client({ name: `fluidbox-gate-${SERVER_NAME}`, version: "0.5.0-rc.1" }, { capabilities: {} }); // x-release-please-version
...
const server = new Server(
  { name: `fluidbox-gate-${SERVER_NAME}`, version: "0.5.0-rc.1" }, // x-release-please-version
  { capabilities: { tools: {} } },
);
